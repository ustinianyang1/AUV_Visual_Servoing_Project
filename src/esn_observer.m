...
%   Phi: Current ESN reservoir state
    ...
    % d_hat_x2 = -K2*M0^{-1}*J^T*hat_x1 + M0^{-1}[tau - W_out_hat^T*Phi - g0]
    invM0 = inv(M0);
    d_hat_x2 = -K2 * invM0 * J' * hat_x1 + invM0 * (tau - W_out_hat' * Phi - g0);
